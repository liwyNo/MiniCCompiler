...
export LD_LIBRARY_PATH=/home/riscv/lib
export PK_PATH=/home/riscv/riscv64-unknown-elf/bin/pk
status=$?
if [ ${status} -ne 0 ]; then
...
do
    ...
    ./handin/tigger_parser ./src/$x.t ./src/$x.s
    riscv64-unknown-elf-gcc -o ./src/$x ./src/$x.s lib.c
	...
	y=${y/\.in/}
	#echo $x, $y
        spike $PK_PATH ./src/$x < ./test/$x/$y.in > ./test/$x/$y.myout 2> /dev/null
